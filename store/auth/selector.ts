...
export const selectAuthUser = createSelector(selectAuthStateDomain, (state) => state.user);

export const selectAuthToken = createSelector(selectAuthStateDomain, (state) => state.token);
